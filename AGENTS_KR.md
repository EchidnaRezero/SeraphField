...
- 이 저장소의 문서는 두 종류로 나누고, 둘의 경계를 분명히 유지합니다.
- 프로젝트용 문서는 저장소 규칙, 작업 흐름, 구조, 도구 사용법을 설명하는 문서입니다.
  - 대표 예시: `AGENTS.md`, `AGENTS_KR.md`, `README.md`, `docs/**/*.md`, `skills/**/SKILL.md`, `skills/**/SKILL_KR.md`
- 콘텐츠 문서는 주제 자체를 다루는 공개 가능한 학습/포트폴리오 문서입니다.
  - 대표 예시: `DRAFT/**/*.md`, `RAW/THEORY/**/*.md`, `RAW/PAPER/**/*.md`, `RAW/REPO/**/*.md`, `RAW/IMPLEMENT/**/*.md`
- 콘텐츠 문서 안에는 공개용 콘텐츠 규칙 때문에 꼭 필요한 경우가 아니면 프로젝트 작업 흐름 규칙을 넣지 않습니다.
- 프로젝트용 문서의 지침을 주제 자체의 콘텐츠처럼 섞어 쓰지 않습니다.
