...
- Keep Mermaid labels short, and keep one arrow meaning per diagram when the math appears inside diagram labels.
...
- If the document contains diagrams, do Mermaid labels avoid TeX and stay structurally short?
...
5. If the Mermaid structure itself is the problem, redraw the diagram so arrow meaning stays consistent and labels stay short
